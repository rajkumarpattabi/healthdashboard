...
**Version:** 1.4 — BUILD-READY (adds missing-parameter / sparse-series handling for trends & dashboard)
**Date:** 09-Aug-2026
...
**Status:** Ready to build on your go. Mockup v3 (matching this spec, incl. a deliberately sparse TSH series) delivered alongside.
...
*End of SRS v1.4 (build-ready; navigation, Sync tab, and sparse-parameter handling all incorporated). On your go I'll build: (1) the two CSVs from all 11 reports, validated against §11, then (2) the mealfast-style PWA with the four-tab layout, sparse-aware trends, and Drive sync.*
